...
A command (*Insert object mention*) and a mobile-friendly variant (*Open object mention popup (mobile)*) are available in the command palette for keyboardless workflows.
